...
import com.hphil.tavern.util.MergeUtil.updateChildSet
import com.hphil.tavern.util.PanacheQueryFilter
import com.hphil.tavern.util.RemovalIndicator
...
@Authenticated
class EstablishmentAssetsResource : ManagedEstablishmentTrait {
    @Inject
    ...
    fun add(@Context ctx: SecurityContext, request: AddAssetRequest) {
        assetRepository.persist(
            Asset(
                getEstablishment(establishmentRepository, ctx),
                request.name,
